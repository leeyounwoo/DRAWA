    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instagram_url', models.TextField(null=True)),
                ('kakao_url', models.TextField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wish', models.ManyToManyField(blank=True, related_name='wishlist', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Draw',
            fields=[
                ...
                ('participate', models.ManyToManyField(blank=True, related_name='participated_draws', to=settings.AUTH_USER_MODEL)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='drawa.product')),
                ('reserve', models.ManyToManyField(blank=True, related_name='reserved_draws', to=settings.AUTH_USER_MODEL)),
